...
public class Enemy2 : Enemy
{
   private Rigidbody2D myRigidbody;
    ...
    {
        // Call base functionality (e.g., XP gain)
        base.Die();

        // Show Game Complete canvas for this specific enemy
        if (gameCompleteCanvas != null)
        {
            gameCompleteCanvas.SetActive(true);
        }

        // Optionally disable enemy-related functionality instead of immediate destruction
